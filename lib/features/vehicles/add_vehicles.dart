...
class _AddVehicleScreenState extends State<AddVehicleScreen> {
  ...
  final _vinOrNpController = TextEditingController();
  ...
  Future<String> _uploadImage(String vehicleUid, String userDocId) async {
    final ref = FirebaseStorage.instance
        .ref()
        .child('vehicle_images/$userDocId/$vehicleUid.jpg');
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_pickedImage != null) {
        imageUrl = await _uploadImage(vehicleUid, userDocId);
      }
      ...
      await Provider.of<VehicleProvider>(
        context,
        listen: false,
      ).addVehicle(vehicle, userDocId);
      Navigator.pop(context);
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Error uploading vehicle: $e')),
      );
    } finally {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                controller: _vinOrNpController,
                decoration: const InputDecoration(
                  labelText: "VIN or Number Plate",
                ),
                validator: (val) =>
