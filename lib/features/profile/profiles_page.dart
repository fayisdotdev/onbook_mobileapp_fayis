...
import 'package:onbook_app/features/profile/user_information/profile_view.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ProfileInfoFrame(
            onTap: () => _navigate(context, const UserDetailsScreen()),
            iconPath: AppIcons.profileuser,
            title: 'Profile',
            showSubtitle: false,
          ),
          ProfileInfoFrame(
            onTap: () => _navigate(context, const AddVehicleScreen()),
